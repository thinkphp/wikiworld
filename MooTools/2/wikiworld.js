  ...
  function showCountry(elm) {
        ...
        */
        ...
        var img = '<h2>' + bb.name + '</h2><div class="img"><img src="'+ image +'" alt="'+ bb.name +'"></div>';
          ...
          * Note: you can use: new Request.HTML({url: 'wikipedia.php', onSuccess: function{} }).get({location: name});
          *              OR
          *                    new Request.HTML({url: 'wikipedia.php?location='+name, onSuccess: function{} }).get(); 
          */  
          new Request.HTML({
              url: 'wikipedia.php',
              onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript){
                 ...
                 var data;
                 if(responseHTML) {
                   data = responseHTML.replace(/"\/wiki/g,'"http://en.wikipedia.org/wiki');
          ...
          }).get({location: name}); //end Request.JSON
